...
import { Calendar, Trash2, Check, Clock, User, AlertCircle, FileText, ChevronDown, ChevronUp, Download } from 'lucide-react';
                              ...
                              <div className="mt-4 pt-3 border-t border-slate-200/50 space-y-2">
                                <div className="flex justify-between items-center mb-1">
                                  ...
                                  <button
                                    ...
                                    className="inline-flex items-center px-3 py-1 bg-primary/10 hover:bg-primary/20 text-primary font-bold rounded-lg text-[10px] transition-colors space-x-1"
                                    title="Download PDF"
                                  >
                    ...
                    {app.prescription && (
                      <div className="mt-2 pt-2 border-t border-slate-200/50 space-y-1 text-left">
                        <div className="flex justify-between items-center mb-1.5">
                          ...
                          <button
                            onClick={() => handleDownloadPrescription(app)}
                            className="inline-flex items-center px-2 py-0.5 bg-primary/10 text-primary font-bold rounded text-[9px] space-x-0.5"
                          >
